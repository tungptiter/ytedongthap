...
OPERATORS = {
    ...
    # Operators which accept three arguments.
    '$has': lambda f, a, fn: f.any(_sub_operator(f, a, fn)),
    '$any': lambda f, a, fn: f.any(_sub_operator(f, a, fn)),
}
...
class Filter(object):
    ...
    def from_dictionary(dictionary):
        ...
        if ('$or' not in dictionary) and ('$and' not in dictionary) and bool(dictionary):
...
class SearchParameters(object):
    ...
    def from_dictionary(dictionary):
        ...
        filters = from_dict(dictionary.get('filters', {}))
...
class QueryBuilder(object):
    ...
    def create_query(session, model, search_params, _ignore_order_by=False):
        ...
        filters = bool(search_params.filters) and [create_filt(model, search_params.filters)] or []
